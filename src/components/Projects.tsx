...
const Projects = () => {
  ...
  // Mapping the 0.54 - 0.78 range (PORTO DWELL) to horizontal pan
  const x = useTransform(scrollYProgress, [0.54, 0.78], ["0%", "-80%"]);
    ...
    <>
      ...
      >
        <div className="absolute top-12 left-[5vw] z-20">
          ...
          <span className="text-[10px] uppercase tracking-[0.8em] mt-2 block opacity-30">Scroll to Explore // Click to Decode</span>
        </div>
            ...
            {PROJECTS.map((project, index) => (
              ...
              >
                <div className="absolute inset-0 grayscale contrast-125 opacity-70 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000 ease-smooth">
                  <img src={project.image} alt={project.title} className="w-full h-full object-cover scale-105 group-hover:scale-100 transition-transform duration-1000" />
