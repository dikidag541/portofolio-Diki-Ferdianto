...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-neural-cyan/10 blur-[120px] rounded-full opacity-50 group-hover:opacity-60 transition-opacity"></div>
        <div
          className="relative w-full h-full overflow-hidden transition-all duration-1000 border border-white/5"
          style={{
            maskImage: 'radial-gradient(ellipse at 50% 45%, black 70%, transparent 100%)',
            WebkitMaskImage: 'radial-gradient(ellipse at 50% 45%, black 70%, transparent 100%)'
          }}
        >
          <img
            src="/input_file_0.png"
            alt="Diki Ferdianto"
            className="w-full h-full object-cover scale-110 group-hover:scale-105 transition-transform duration-1000 brightness-125 contrast-110"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-off-black via-transparent to-transparent opacity-10"></div>
      ...
      >
        <div className="text-center">
          <h1
            ref={titleRef}
            className="text-[clamp(3rem,14vw,14rem)] font-bold uppercase leading-[1.1] tracking-[-0.08em] overflow-visible drop-shadow-[0_0_15px_rgba(0,242,255,0.1)] whitespace-nowrap"
          >
            DIKI<br />
            <span className="text-stroke-cyan tracking-[0.02em]">FERDIANTO</span>
          </h1>
